/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5826ed0cce6e8de6262b4b306711b65)
// Runtime types generated with workerd@1.20260521.1 2026-04-02 nodejs_compat
interface __BaseEnv_Env {
	PACKAGE_PROXY_CONFIG: KVNamespace;
	install_logs: D1Database;
	ASSETS: Fetcher;
	AUDIT_TRACKER: DurableObjectNamespace<import("./src/index").AuditTrackerObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AuditTrackerObject";
	}
